...
const links = [
{
    ...
    link:'mailto:vaibhu1934@gmail.com'
},
{
    name:'LinkedIn',
    icon:'/Contact/linkedin.svg',
    link:'https://www.linkedin.com/in/vaibhav1328/'
},
{
    name:'Medium',
    icon:'/Contact/medium.svg',
    link:'https://medium.com/@v599568'
},
{
    name:'GitHub',
    icon:'/Contact/github.svg',
    link:'https://github.com/vaibhavc13'
},
    ...
    return (
        <div className={styles.contact} id="contact">
            ...
            <div className={styles.right}>
                ...
                <a href={`mailto:vaibhu1934@gmail.com?from=${email}&name=${name}&body=${message}`} className={styles.submit} >Submit</a>
            </div>
        </div>
    )
}
