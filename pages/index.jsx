...
import MetaImg from '../public/vaibhavChutiya.jpg'
import Particles from 'react-tsparticles';
const particleOptions = require('../utils/particles.json');

export async function getStaticProps(context) {
    let response = await fetch(`https://api.rss2json.com/v1/api.json?rss_url=https://medium.com/feed/@v599568`);
...
export default function Home({ blogs }) {
    ...
    return (!loading ? <>
        <Head>
            <title>Vaibhav C</title>
            <meta name="description" content="Hey, a Full Stack Developer here" />
            <meta name="title" property="og:title" content="Vaibhav C" />
            <meta property="keywords" content="Vaibhav C Portfolio Web Development" />
